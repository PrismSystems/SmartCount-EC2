        ...
        <div className="w-full h-screen bg-gray-100 flex items-center justify-center p-4">
            <div className="w-full max-w-md mx-auto bg-white p-8 rounded-2xl shadow-lg">
                ...
                <p className="text-lg text-center text-gray-500 mb-8">
                    Your takeoff{' '}
                    <span className="inline-block animate-bounce hover:animate-pulse text-2xl transform hover:scale-110 transition-transform duration-300 hover:drop-shadow-lg">
                        🚀
                    </span>
                    , accelerated.
                </p>
